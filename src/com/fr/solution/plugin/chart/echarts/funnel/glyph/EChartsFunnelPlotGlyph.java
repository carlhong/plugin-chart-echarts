...
public class EChartsFunnelPlotGlyph extends EChartsPlotGlyph {

    private static final NumberFormat format = new DecimalFormat("##%");

    private RoseType roseType;

    public EChartsFunnelPlotGlyph() {
        this(RoseType.NONE);
    }

    public EChartsFunnelPlotGlyph(RoseType roseType) {
        this.roseType = roseType;
    }

    @Override
    public String getPlotGlyphType() {
        return "EChartsFunnelPlotGlyph";
    }

    @Override
    public String getChartType() {
        return "EChartsFunnel";
    }
